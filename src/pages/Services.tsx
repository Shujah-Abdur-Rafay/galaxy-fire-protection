...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: (
        <img src="/images/SprinklerHeads.jpg" alt="Sprinkler Heads" className="max-h-40 w-auto object-contain transition-transform duration-500 group-hover:scale-105" />
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <img src="/images/fire-safety-plans.jpeg" alt="Fire Safety Plans" className="max-h-40 w-auto object-contain transition-transform duration-500 group-hover:scale-105" />
      )
    }
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <span>Call Us: 416.230.7848</span>
              </a>
            </div>
          </div>
        </div>
